"""Translator sub-agent: language detection and Groq-backed translation to English."""
...
# Global service instance for translation (kept for backward-compatible imports)
